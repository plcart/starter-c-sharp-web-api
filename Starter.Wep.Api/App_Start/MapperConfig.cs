        ...
        public static void RegisterMaps()
        {
            Mapper.Initialize(cfg =>
            {
                cfg.CreateMap<PageTitle, PageTitleModel>()
                    ...
                    .ForMember(dest => dest.MediaValue,
                    opt => opt.ResolveUsing(x => (x.MediaType == MediaType.File || x.MediaType == MediaType.Image) && !string.IsNullOrEmpty(x.MediaValue) ?
                    "http://localhost:64758/" + x.MediaValue : x.MediaValue))
                ...
                cfg.CreateMap<PageTitleModel, PageTitle>()
                    ...
                    .ForMember(dest => dest.MediaValue, opt => opt.Ignore())
